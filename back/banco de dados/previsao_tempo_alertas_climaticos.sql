...
--
-- Dumping data for table `alertas_climaticos`
--

LOCK TABLES `alertas_climaticos` WRITE;
/*!40000 ALTER TABLE `alertas_climaticos` DISABLE KEYS */;
/*!40000 ALTER TABLE `alertas_climaticos` ENABLE KEYS */;
UNLOCK TABLES;
